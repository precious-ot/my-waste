...
export default function Sort(){
    ...
    return(
        ...
        <div className="relative bg-blue-950 opacity-95 mt-8 grid md:flex md:justify-end md:place-items-center text-white p-8 rounded-4xl">
        ...
        {open && (
                <div onClick={handleclick} className="absolute z-999 bg-black text-white border
                 border-neutral-700 rounded-xl mt-28 md:mt-35 py-1 min-w-50 overflow-auto" tabIndex={1}>
                    <li onClick={lowClick} className="ps-6 grid py-2 hover:bg-blue-900 cursor-pointer" key={Option}>
                        Low to High</li>
                    <li onClick={highClick} className="ps-6 py-2 grid hover:bg-blue-900 cursor-pointer" key={Option}>
                        High to Low</li>
                </div>
            )}
            </div>
